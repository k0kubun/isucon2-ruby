DROP DATABASE IF EXISTS isumaster2;
CREATE DATABASE isumaster2 DEFAULT CHARACTER SET 'utf8';

GRANT ALL ON isumaster2.* TO 'isumaster2'@'%' IDENTIFIED BY 'throwing';
GRANT ALL ON isumaster2.* TO 'isumaster2'@'localhost' IDENTIFIED BY 'throwing';
